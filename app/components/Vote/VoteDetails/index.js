...
class VoteDetails extends Component {
    ...
    async clickSubmit() {
        ...
        this.setState({
            ...
            modalConfirmText : `Submit ${count} Votes for ${this.state.rep.url} (${address} ?`
        });
    }
    ...
    async modalConfirm() {
        ...
        let response = await client.vote(this.state.selectedWallet.privateKey, votes).catch(x => null);
        ...
        return (
            <Secondary className={styles.container}>
                ...
                <div className={styles.subContainer}>
                    ...
                    <VoteAmountSlider onSliderChange={this.onSliderChange.bind(this)}
                                      totalTP={selectedWallet.frozenBalance}/>
                    <Button onClick={this.clickSubmit.bind(this)}
                            className={`${styles.btn} ${buttonStyles.button} ${buttonStyles.black}`}>Submit Your
                        Vote</Button>
                </div>
