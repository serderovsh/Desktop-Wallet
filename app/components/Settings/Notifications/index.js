...
class Notifications extends Component {
    ...
    componentDidMount() {
        this.state.pushNotif = getValue(this.props.storage, STORAGE_NAMESPACE, KEY_PUSHNOTIF, true);
        this.state.txNotify= getValue(this.props.storage, STORAGE_NAMESPACE, KEY_NOTIFY_CONFIRM, false);
    }
      ...
      <Secondary>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.toggleContainer}>
            ...
            <Checkbox toggle onChange={this.setPushNotif} checked={this.state.pushNotif} className={styles.toggle} />
          </div>
          <div className={styles.divider} />
          <div className={styles.toggleContainer}>
            <div className={styles.toggleLabel}>Notify me when transactions are confirmed</div>
            <Checkbox toggle onChange={this.setTxNotify} checked={this.state.txNotify} className={styles.toggle} />
          </div>
        </div>
      </Secondary>
    );
