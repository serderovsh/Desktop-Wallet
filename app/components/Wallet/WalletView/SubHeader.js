      ...
      <div className={styles.main}>
        ...
        <div className={styles.subContainer}>
          <div className={styles.subAmountContainer}>
            ...
            <div className={styles.subAmount}><FormattedNumber value={this.props.account.bandwidth} /> <span>BW</span></div>
          </div>
          <div className={styles.subAmountContainer}>
            <div className={styles.subAmountHeader}>TronPower</div>
            <div className={styles.subAmount}><FormattedNumber value={this.props.account.frozenBalance} /> <span>TP</span></div>
            { this.props.account.frozenBalance > 0 ? <div className={styles.tpExpire}>Expires: <FormattedDate value={ this.props.account.frozenExpireTime} /> <FormattedTime value={this.props.account.frozenExpireTime} /></div> : '' }
          </div>
        </div>
