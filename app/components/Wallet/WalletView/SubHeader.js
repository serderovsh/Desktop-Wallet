  ...
  render() {
    return (
      <div className={styles.main}>
        <div className={styles.mainAmount}>{ (this.props.account.trx / 1000000).toFixed(8) } <span>TRX</span></div>
        ...
        <div className={styles.scroll}>
          <div className={styles.container}>
              <SubHeaderToken amount={(this.props.account.trx / 1000000).toFixed(8)} token="TRX"/>
            {
